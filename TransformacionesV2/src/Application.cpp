...
{
	int x = 0, y = R, dE = (2 * x) + 3, dsE = 2 * (x - y) + 5, d = 1 - R, dx = 1, dy = 1, z = dx - (R << 1);
...
std::vector<Vec3> Application::poligonitos(int lados, int r)
{
	std::vector<Vec3> SuperVectour;
	Vec3 vec;
	float angulo = 0, incremento = 360 / lados;
	for (int i = lados; i--;) {
		vec.v[0] = r * cos((angulo * radtodeg)) + X1;
		vec.v[1] = r * sin((angulo * radtodeg)) + Y1;
		vec.v[2] = 1;
...
{
	Matrix3 rotacion;
	rotacion.matx[0].v[0] = cos(angulo);
	rotacion.matx[0].v[1] = -sin(angulo);
	rotacion.matx[0].v[2] = 0;
	rotacion.matx[1].v[0] = sin(angulo);
	rotacion.matx[1].v[1] = cos(angulo);
	rotacion.matx[1].v[2] = 0;
	rotacion.matx[2].v[0] = 0;
	rotacion.matx[2].v[1] = 0;
	rotacion.matx[2].v[2] = 1;
	return rotacion;
}
...
{
	Matrix3 translacion;
	translacion.matx[0].v[0] = 1;
	translacion.matx[0].v[1] = 0;
	translacion.matx[0].v[2] = x;
	translacion.matx[1].v[0] = 0;
	translacion.matx[1].v[1] = 1;
	translacion.matx[1].v[2] = y;
	translacion.matx[2].v[0] = 0;
	translacion.matx[2].v[1] = 0;
	translacion.matx[2].v[2] = 1;
	return Matrix3();
}
